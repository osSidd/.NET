...
export default function TicketCard(){
    return (
        <div className="w-64 bg-white shadow-2xl overflow-hidden flex flex-col items-center mix-blend-hard-light" style={{height:'625px'}}>
        <div className="px-3 pt-3">
            <ImageBox img="/ticket.jpeg" minWidth="226px"/>
        </div>
        <div className="flex justify-between items-center w-full mt-4">
            <div className=" w-5 h-5 bg-gray-200 rounded-full" style={{marginLeft: '-10px'}}></div>
            <div className=" w-52 h-1 border-t border-dashed border-gray-400"></div>
            <div className=" w-5 h-5 bg-gray-200 rounded-full" style={{marginRight: '-10px'}}></div>
        </div>
